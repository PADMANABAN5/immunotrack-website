...
export default function AboutSection() {
  return (
    <section id="about" className="ab-page" aria-label="About">
      {/* ── HERO SECTION ──────────────────────────────────────── */}
      ...
      <section className="ab-pillars" aria-label="Mission Pillars">
        <div className="ab-pillars-grid">
          <Reveal className="ab-pillar-card">
          ...
          <Reveal className="ab-pillar-card" delay={1}>
            <div className="ab-pillar-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <Reveal className="ab-pillar-card" delay={3}>
            <div className="ab-pillar-icon">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
